...
const lineasInvestigacion = {
  ...
  content: [{
    label: 'Hidrocarburos',
    icon: <svg id="Capa_1" version="1.1" viewBox="0 0 489.915 489.915" x="0px" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg" y="0px">
      <g>
        <g>
  ...
  },
  {
    ...
    icon: <svg id="Layer_1" version="1.1" viewBox="0 0 512.013 512.013" x="0px" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg" y="0px">
      <g>
        <g>
          <g>
  ...
  },
  {
    ...
    icon: <svg fill="none" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
