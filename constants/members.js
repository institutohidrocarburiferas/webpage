export const members = [
  ...
  },
  {
    ...
    title: null,
    description: `Docente de la Carrera de Petróleos y Coordinador de la Unidad de Titulación en la Universidad Central del Ecuador. Fue secretario de SPE Sección Ecuador durante el período 2020-2022 y en la actualidad es el Faculty Advisor de la Sección Ecuador.
    
    Es Ingeniero de Petróleos por la Universidad Central del Ecuador y Máster de Petróleos por la Universidad de Miskolc-Hungría con experiencia en la industria petrolera en el área de producción y levantamiento artificial en operaciones de campo para la empresa pública y privada. Ha participado en varios congresos relacionados con la energía y la transición energética; fue seleccionado para participar en la escuela de verano IEA GHG CCUS pero debido a la pandemia de Covid-19 el evento fue pospuesto. Su interés es trabajar en temas relacionados a prospectiva energética y proyectos de Captura y Almacenamiento de Carbono.`
  },
  {
    name: 'Luis Mejía',
