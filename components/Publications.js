...
function Card ({title, image, url, date, download}) {
  return (
    <a className='flex items-center justify-around w-full h-auto md:gap-5 py-5 mx-auto border-b-2 cursor-pointer md:p-5 md:hover:bg-gradient-to-tl md:hover:to-blue-100 md:hover:from-transparent dark:hover:text-black group' href={url} rel="noreferrer" target="_blank">
