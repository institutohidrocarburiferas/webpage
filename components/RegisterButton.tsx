...
export const RegisterButton: React.FC = () => {
  ...
  return <Link href={`${exception}/#expositions`}>
  <a
    className='flex items-center justify-center text-center py-1 w-auto px-2 text-xs font-semibold text-black rounded md:px-6 md:py-2 sm:text-lg md:text-xl hover:scale-105 bg-gradient-to-tr hover:from-amber-400 scroll-smooth hover:to-white from-amber-500 to-white'
