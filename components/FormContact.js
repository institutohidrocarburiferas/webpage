...
export function FormContact () {
  ...
  return <form ref={form} onSubmit={handleSubmit} method='POST'className='flex flex-col m-4'>
    <label className='flex flex-col gap-1 py-2'>
      <span className='font-bold'>Nombre completo</span>
      <input name="nombre" className='px-5 py-2 border rounded-md border-black/30' type="text" placeholder='Ingrese su nombre completo' required />
    </label>
    {/* <label className='flex flex-col gap-1 py-2'>
    ...
    <label className='flex flex-col gap-1 py-2'>
      ...
      <textarea name="message" className='px-5 py-2 border rounded-md border-black/30' type="mail" placeholder='Ingrese su mensaje' rows={7} required />
    </label>
